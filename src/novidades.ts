...
export const NOVIDADES: Novidade[] = [
  {
    ...
    titulo: "Duas formas novas de classificar e duas de selecionar",
    resumo:
    ...
    itens: [
      ...
      },
      {
        ...
        texto:
          "Arrastar o rato por cima da grelha seleciona todas as imagens por onde passa. Se começar numa que já esteja selecionada, desmarca-as em vez de marcar — a mesma regra do explorador de ficheiros do Windows.",
        video: "arrastar.mp4",
      ...
      },
      {
        ...
        texto:
          "À esquerda, os grupos passaram a estar ordenados pelos que têm mais plântulas por anotar. Os já concluídos saem da lista e ficam recolhidos numa gaveta discreta, no fundo — continuam a um clique de distância.",
      },
    ],
  },
];
